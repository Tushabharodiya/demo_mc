<main role="main" class="container">
  <div class="my-3 p-4 bg-white rounded box-shadow">
    <div class="span small text-center">
        <img src="<?php echo base_url();?>source/image/nodata.webp" alt="permission-denied" height="200" width="200">
        ...
        <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="#" onClick="history.back();" class="text-white"> Go Back </a> </div>
    </div> 
  </div>
</main>
