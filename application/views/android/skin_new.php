...
<?php
    $dataName = null;  $dataDescription = null;  $dataImage = null;  $dataBundle = null; 
        ...
        <div class="pt-3 overflow-none">     
            <div class="row small">
                <div class="form-group col-md-12">
                    ...
                    <select name="category_id" id="select2" class="form-control mySelect" data-live-search="true">
...
<script>
    $(document).ready(function() {
        var placeholder = "Choose Category Name";
        $(".mySelect").select2({
