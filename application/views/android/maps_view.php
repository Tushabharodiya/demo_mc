<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="span border border-gray bg-light p-3">
            ...
            <div class="btn btn-primary btn-sm mb-0 mb-md-0"><a href="<?php echo base_url();?>maps-new" class="text-white"> New Maps </a></div>
            <div class="btn btn-info btn-sm mb-0 mb-md-0"><a href="<?php echo base_url();?>copy-bucket/maps" class="text-white"> Copy Bucket </a></div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="card my-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>maps-edit/<?php echo md5($data['unique_id']);?>" class="text-white"> Edit Data </a></div>
                            </div>
                        </div>
                    </div> 
                </div>
    ...
    <?php if(empty($viewMaps)) { ?>
        <div class="my-3 p-4 bg-white rounded box-shadow">
            <div class="span small text-center">
                ...
                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>maps-new" class="text-white"> New Maps </a></div>
            </div> 
        </div>
    <?php } ?>
</main>
