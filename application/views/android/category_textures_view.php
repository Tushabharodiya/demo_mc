<main role="main" class="container">
  ...
  <div class="my-3 p-3 bg-white rounded box-shadow">
    <div class="span border border-gray bg-light p-3">
      ...
      <div class="btn btn-primary btn-sm mb-0 mb-md-0"><a href="<?php echo base_url();?>category-textures-new" class="text-white"> New Category Textures </a></div>
    </div>
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tr class="small">
            ...
            <td> 
              <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>category-textures-edit/<?php echo md5($data['category_id']);?>" class="text-white"><i class="far fa-edit"></i></a></div>
            </td>
          </tr>
          <?php } ?>
        </table>
  ...
  <?php if(empty($viewCategoryTextures)) { ?>
    <div class="my-3 p-4 bg-white rounded box-shadow">
      <div class="span small text-center">
        ...
        <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>category-textures-new" class="text-white"> New Category Textures </a></div>
      </div> 
    </div>
  <?php } ?>
</main>
