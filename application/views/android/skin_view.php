<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="span border border-gray bg-light p-3">
            ...
            <div class="btn btn-primary btn-sm mb-0 mb-md-0"><a href="<?php echo base_url();?>skin-new" class="text-white"> New Skin </a></div>
            ...
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-3 mt-3">
                        <input type="submit" name="search" class="btn btn-outline-secondary" value="Search">
                        <input type="submit" name="reset" class="btn btn-outline-secondary" value="Reset">
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="card my-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>skin-edit/<?php echo md5($data['unique_id']);?>" class="text-white"> Edit Data </a></div>
                            </div>
                        </div>
                    </div> 
                </div>
    ...
    <?php if(empty($viewSkin)) { ?>
        <div class="my-3 p-4 bg-white rounded box-shadow">
            <div class="span small text-center">
                ...
                <h5 class="d-block mb-1">Skin Database is Empty</h5>
                <p class="d-block mb-3">Please add skin from the below button.</p>
                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>skin-new" class="text-white"> New Skin </a></div>
            </div> 
        </div>
    <?php } ?>
</main>
